...
prompt_consulta_seguro = ChatPromptTemplate.from_messages(
  [
    ("system", "Responda usando excluisvamente o conteudo fornecido"),
    ("human", "{query} \n\n Contexto: \n {contexto} \n\n Resposta:" )  
  ]
)
...
print(responder("Como devo proceder caso tenha um item roubado e caso eu tenha o cartao platinum "))